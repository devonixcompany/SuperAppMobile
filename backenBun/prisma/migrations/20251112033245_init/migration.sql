...
-- CreateIndex
CREATE UNIQUE INDEX "PaymentCard_omiseCustomerId_key" ON "PaymentCard"("omiseCustomerId");
...
-- AddForeignKey
ALTER TABLE "connectors" ADD CONSTRAINT "connectors_chargePointId_fkey" FOREIGN KEY ("chargePointId") REFERENCES "charge_points"("id") ON DELETE SET NULL ON UPDATE CASCADE;
