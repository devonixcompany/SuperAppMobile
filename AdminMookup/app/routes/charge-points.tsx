...
import { ChargePointDetailModal } from "../components/ChargePointDetailModal";
...
export default function ChargePoints() {
  ...
  // Handle view details
  const handleViewDetails = (chargePoint: ChargePoint) => {
                    ...
                    <tr key={chargePoint.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end gap-2">
                          <button
                            onClick={() => handleViewDetails(chargePoint)}
                            className="text-green-600 hover:text-green-900 p-2 rounded-lg hover:bg-green-50 transition-colors"
                            title="ดูรายละเอียดและสถานะ Real-time"
                          >
