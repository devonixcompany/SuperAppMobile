            ...
            >
              ...
              >
                {loading ? (
                  ...
                  <Text className="text-xl font-semibold py-4 text-center text-white">ส่งรหัส</Text>
                )}
              </LinearGradient>
            </TouchableOpacity>
          </View>
          ...
          <View className="items-start  mb-8">
            {countdown > 0 ? (
              <Text className="text-base text-gray-500">
                ไม่ได้รับ OTP? <Text className="text-[#51BC8E] font-medium underline">ส่งใหม่</Text>
              </Text>
            ) : (
              <TouchableOpacity
                onPress={resendOTP}
              ...
              >
                <Text className={`text-base ${resendLoading ? 'text-gray-400' : 'text-neutral-600 text-center underline'} font-medium underline`}>
